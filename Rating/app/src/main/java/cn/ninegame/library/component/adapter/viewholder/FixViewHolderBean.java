...
public class FixViewHolderBean extends ItemViewHolderBean {
    ...
    /**
     * the data binding the {@link ItemViewHolder}, and you can get it by {@link cn.ninegame.library.component.adapter.model.RecyclerDataModel#getHeaderOrFooterItem(int)}
     */
     ...
     * @param itemViewHolderLayoutId the view's layoutId that would be used to inflating item view
     * @param itemViewHolderClazz the class of the {@link ItemViewHolder}'s implement
     * @param data the data binding the {@link ItemViewHolder}, and you can get it by {@link cn.ninegame.library.component.adapter.model.RecyclerDataModel#getHeaderOrFooterItem(int)}
