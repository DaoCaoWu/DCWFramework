...
import com.dcw.app.base.mvp.factory.RequiresPresenter;
import com.dcw.app.presentation.account.presenter.LoginPresenter;
...
public class LoginFragment extends BaseFragmentWrapper implements LoginView {
    ...
    @Override
    public void initUI() {
//        new LoginController((com.dcw.app.biz.account.LoginView) findViewById(R.id.root_view), new UserModel());
